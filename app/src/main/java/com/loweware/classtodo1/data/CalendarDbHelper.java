...
//        MakeTable_CalendarListEntry(sqLiteDatabase);
//        MakeTable_DayCycleEntry(sqLiteDatabase);
//        MakeTable_EventEntry(sqLiteDatabase);
        Log.i(LOG_TAG, "OUT - CalendarDbHelper.onCreate()");
    }

//    private void MakeTable_CalendarListEntry(SQLiteDatabase sqLiteDatabase) {
//        final String SQL_CREATE_SCHEDULE_TABLE = "CREATE TABLE " + CalendarContract.CalendarListEntry.TABLE_NAME + " (" +
//                CalendarListEntry._ID + " INTEGER PRIMARY KEY AUTOINCREMENT," +
//                CalendarListEntry.COLUMN_ACCOUNT_NAME + " TEXT NOT NULL, " +
//                CalendarListEntry.COLUMN_CALENDAR_ID + " TEXT NOT NULL, " +
//                CalendarListEntry.COLUMN_CLASS_NAME + " TEXT NOT NULL" + ");";
...
//    }
    ...
    private void MakeTable_ScheduleEntry(SQLiteDatabase sqLiteDatabase) {
        final String SQL_CREATE_SCHEDULE_TABLE = "CREATE TABLE " + ScheduleEntry.TABLE_NAME + " (" +
                ...
                ScheduleEntry.COLUMN_ACCOUNT_NAME + " TEXT NOT NULL, " +
...
//                EventEntry.COLUMN_ACCOUNT_NAME + " TEXT NOT NULL, " +
...
//        sqLiteDatabase.execSQL("DROP TABLE IF EXISTS " + CalendarListEntry.TABLE_NAME);
