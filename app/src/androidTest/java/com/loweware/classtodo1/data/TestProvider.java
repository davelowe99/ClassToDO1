...
//import com.loweware.classtodo1.data.CalendarContract.CalendarListEntry;
...
//                DayCycleEntry.CONTENT_URI,
//                null,
//                null
//        );
//        mContext.getContentResolver().delete(
//                CalendarListEntry.CONTENT_URI,
//                null,
//                null
//        );
        mContext.getContentResolver().delete(
...
//        );
        ...
        assertEquals("Error: Records not deleted from ScheduleEntry table during delete", 0, cursor.getCount());
        cursor.close();
...
//                null
//        );
//        assertEquals("Error: Records not deleted from DayCycleEntry table during delete", 0, cursor.getCount());
//        cursor.close();
...
//                null
//        );
//        assertEquals("Error: Records not deleted from CalendarListEntry table during delete", 0, cursor.getCount());
//        cursor.close();
//
...
//                null
//        );
//        assertEquals("Error: Records not deleted from EventEntry table during delete", 0, cursor.getCount());
//        cursor.close();
    }
...
//        db.delete(DayCycleEntry.TABLE_NAME, null, null);
//        db.delete(CalendarListEntry.TABLE_NAME, null, null);
...
//        db.delete(EventEntry.TABLE_NAME, null, null);
    ...
    public void testProviderRegistry() {
        ...
        ComponentName componentName = new ComponentName(mContext.getPackageName(),
                CalendarProvider.class.getName());
        try {
            ...
            assertEquals("Error: WeatherProvider registered with authority: " + providerInfo.authority +
                    " instead of authority: " + CalendarContract.CONTENT_AUTHORITY,
                    providerInfo.authority, CalendarContract.CONTENT_AUTHORITY);
    ...
    public void testGetType() {
        String testAccountName = "laurenschoolcalendar@gmail.com";

        // content://com.loweware.classtodo1.data/schedule
        String type = mContext.getContentResolver().getType(ScheduleEntry.CONTENT_URI);
        // vnd.android.cursor.dir/com.loweware.classtodo1.data/days
        assertEquals("Error: the ScheduleEntry CONTENT_URI should return ScheduleEntry.CONTENT_TYPE",
                ScheduleEntry.CONTENT_TYPE, type);

//
//        long testDate = 1419120000L; // December 21st, 2014 // content://com.loweware.classtodo1.data/calendars/laurenschoolcalendar@gmail.com
//        type = mContext.getContentResolver().getType(CalendarListEntry.buildAccountName(testAccountName));
//        // vnd.android.cursor.dir/com.loweware.classtodo1.data/calendars/laurenschoolcalendar@gmail.com
//        assertEquals("Error: the CalendarListEntry CONTENT_URI with location should return CalendarListEntry.CONTENT_TYPE",
//                CalendarListEntry.CONTENT_TYPE, type);
...
//                LocationEntry.CONTENT_TYPE, type);
     ...
     */
    public void testBasicScheduleEntryQueries() {
        // insert our test records into the database
        CalendarDbHelper dbHelper = new CalendarDbHelper(mContext);
        SQLiteDatabase db = dbHelper.getWritableDatabase();

        ContentValues testValues = TestUtilities.createScheduleEntryValues();
        long rowId = TestUtilities.insertScheduleEntryValues(mContext);
        ...
        TestUtilities.validateCursor("testBasicScheduleEntryQueries, location query", locationCursor, testValues);

        // Has the NotificationUri been set correctly? --- we can only test this easily against API
        // level 19 or greater because getNotificationUri was added in API level 19.
        if ( Build.VERSION.SDK_INT >= 19 ) {
            assertEquals("Error: Location Query did not properly set NotificationUri",
                    locationCursor.getNotificationUri(), ScheduleEntry.CONTENT_URI);
        }
    }
...
//        long locationRowId = TestUtilities.insertScheduleEntryValues(mContext);
//
//        // Test the basic content provider query
//        Cursor locationCursor = mContext.getContentResolver().query(
